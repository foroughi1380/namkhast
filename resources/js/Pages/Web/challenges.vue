          ...
          <div class="row mt-1">
            <div class="col-sm-12">
              <fieldset class="form-group position-relative">
                <input type="text" class="form-control search-product" id="iconLeft5" placeholder="جستجو ...">
            ...
            <div class="card-content row">
              ...
              <div class="col-3 text-center my-auto">
                ...
                <div class="cart mr-1 mt-1">
                  <a class=" btn btn-info btn-block"><span class="add-to-cart text-white">شرکت در چالش</span> <a
                      href="app-ecommerce-checkout.html" class="view-in-cart d-none">View In Cart</a></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <div id="product-categories">
                <div class="product-category-title">
                  <h6 class="filter-title mb-1">دسته بندی ها</h6>
                </div>
                <ul class="list-unstyled categories-list">
                  <li>
                      <span class="vs-radio-con vs-radio-primary py-25">
                          ...
                          <span class="ml-50">دسته بندی</span>
                      </span>
                  </li>
                  <li>
                      <span class="vs-radio-con vs-radio-primary py-25">
