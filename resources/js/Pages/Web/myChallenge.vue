            ...
            <div class="card-content row">
              ...
              <div class="col-3 text-center my-auto">
                ...
                <div class="cart mr-1 mt-1">
                  <a class=" btn btn-success btn-block"><span class="add-to-cart text-white">مشاهده پاسخ ها</span></a>
                </div>
                <div class="cart mr-1 mt-1">
                  <a class=" btn btn-info btn-block"><span class="add-to-cart text-white">مشاهده جزئیات</span></a>
                </div>
              </div>
            </div>
          </div>
        </section><!-- END: Challenge Cart -->
