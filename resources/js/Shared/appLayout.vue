  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class=" nav-item active"><a href="/"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">خانه</span></a>
        </li>
        <li class=" navigation-header"><span>دسترسی سریع</span>
        </li>
        <li class=" nav-item"><a href="app-email.html"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Email">پروفایل من</span></a>
        </li>
