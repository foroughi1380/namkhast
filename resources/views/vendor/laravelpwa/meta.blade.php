...
<script type="text/javascript">
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('/serviceworker.js', {
            ...
            console.log('Namkhast PWA: ServiceWorker registration successful with scope: ', registration.scope);
        }, function (err) {
            // registration failed :(
            console.log('Namkhast PWA: ServiceWorker registration failed: ', err);
        });
    }
</script>